...
export default function SibukuCaseStudy({ project }) {
  ...
  const demoImages = [
    { src: '/assets/projects/sibuku/login-admin-light.webp', alt: 'Login', isMobile: false },
    { src: '/assets/projects/sibuku/dashboard-admin-light.webp', alt: 'Admin Dashboard', isMobile: false },
    { src: '/assets/projects/sibuku/dashboard-pengarang-light.webp', alt: 'Author Dashboard', isMobile: false },
    { src: '/assets/projects/sibuku/dashboardpenjualan-pegawai-light.webp', alt: 'Sales Dashboard', isMobile: false },
    { src: '/assets/projects/sibuku/dashboardstok-pegawai-light.webp', alt: 'Stock Dashboard', isMobile: false },
    { src: '/assets/projects/sibuku/databuku-admin-light.webp', alt: 'Book Data Management', isMobile: false },
    { src: '/assets/projects/sibuku/viewbuku-admin-light.webp', alt: 'Book Details View', isMobile: false },
    { src: '/assets/projects/sibuku/catatbuku-pengarang-light.webp', alt: 'Record Book (Author)', isMobile: false },
    { src: '/assets/projects/sibuku/datatransaksi-admin-light.webp', alt: 'Transaction Processing', isMobile: false },
    { src: '/assets/projects/sibuku/catatpenjualan-pegawai-light.webp', alt: 'Record Sales (Employee)', isMobile: false },
    { src: '/assets/projects/sibuku/datastok-admin-light.webp', alt: 'Stock Management', isMobile: false },
    { src: '/assets/projects/sibuku/catatstok-pegawai-light.webp', alt: 'Record Stock (Employee)', isMobile: false },
    { src: '/assets/projects/sibuku/viewstok-admin-light.webp', alt: 'Stock Details View', isMobile: false },
    { src: '/assets/projects/sibuku/datalaporan-admin-light.webp', alt: 'Automated Reporting', isMobile: false },
    { src: '/assets/projects/sibuku/unggahlaporan-admin-light.webp', alt: 'Upload Report', isMobile: false },
    { src: '/assets/projects/sibuku/eksporlaporanexcel-admin-light.webp', alt: 'Export Excel Report', isMobile: false },
    { src: '/assets/projects/sibuku/eksporlaporanpdf-admin-light.webp', alt: 'Export PDF Report', isMobile: false },
    { src: '/assets/projects/sibuku/dataadministrator-admin-light.webp', alt: 'Administrator Data', isMobile: false },
    { src: '/assets/projects/sibuku/databank-admin-light.webp', alt: 'Bank Data', isMobile: false },
    { src: '/assets/projects/sibuku/datagudang-admin-light.webp', alt: 'Warehouse Data', isMobile: false },
    { src: '/assets/projects/sibuku/datakonsumen-admin-light.webp', alt: 'Customer Data', isMobile: false },
    { src: '/assets/projects/sibuku/datakurir-admin-light.webp', alt: 'Courier Data', isMobile: false },
    { src: '/assets/projects/sibuku/datapegawai-admin-light.webp', alt: 'Employee Data', isMobile: false },
    { src: '/assets/projects/sibuku/datapembayaran-admin-light.webp', alt: 'Payment Data', isMobile: false },
    { src: '/assets/projects/sibuku/datapengarang-admin-light.webp', alt: 'Author Data', isMobile: false },
    { src: '/assets/projects/sibuku/editprofile-admin-light.webp', alt: 'Edit Profile', isMobile: false },
    { src: '/assets/projects/sibuku/pencatatanaktifitas-admin-light.webp', alt: 'Activity Log', isMobile: false }
  ];
